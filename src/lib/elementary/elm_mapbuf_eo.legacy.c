/**
 * @brief Implements the EAPI function @ref elm_mapbuf_auto_set.
 */
EAPI void
...
/**
 * @brief Implements the EAPI function @ref elm_mapbuf_auto_get.
 */
EAPI Eina_Bool
...
/**
 * @brief Implements the EAPI function @ref elm_mapbuf_smooth_set.
 */
EAPI void
...
/**
 * @brief Implements the EAPI function @ref elm_mapbuf_smooth_get.
 */
EAPI Eina_Bool
...
/**
 * @brief Implements the EAPI function @ref elm_mapbuf_alpha_set.
 */
EAPI void
...
/**
 * @brief Implements the EAPI function @ref elm_mapbuf_alpha_get.
 */
EAPI Eina_Bool
...
/**
 * @brief Implements the EAPI function @ref elm_mapbuf_enabled_set.
 */
EAPI void
...
/**
 * @brief Implements the EAPI function @ref elm_mapbuf_enabled_get.
 */
EAPI Eina_Bool
...
/**
 * @brief Implements the EAPI function @ref elm_mapbuf_point_color_set.
 */
EAPI void
...
/**
 * @brief Implements the EAPI function @ref elm_mapbuf_point_color_get.
 */
EAPI void
