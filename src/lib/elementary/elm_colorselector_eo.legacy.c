...
/** @brief Legacy C wrapper for elm_obj_colorselector_picked_color_set(). */
EAPI void
...
/** @brief Legacy C wrapper for elm_obj_colorselector_picked_color_get(). */
EAPI void
...
/** @brief Legacy C wrapper for elm_obj_colorselector_palette_name_set(). */
EAPI void
...
/** @brief Legacy C wrapper for elm_obj_colorselector_palette_name_get(). */
EAPI const char *
...
/** @brief Legacy C wrapper for elm_obj_colorselector_mode_set(). */
EAPI void
...
/** @brief Legacy C wrapper for elm_obj_colorselector_mode_get(). */
...
/** @brief Legacy C wrapper for elm_obj_colorselector_palette_items_get(). */
...
/** @brief Legacy C wrapper for elm_obj_colorselector_palette_selected_item_get(). */
...
/** @brief Legacy C wrapper for elm_obj_colorselector_palette_color_add(). */
EAPI Elm_Widget_Item *
...
/** @brief Legacy C wrapper for elm_obj_colorselector_palette_clear(). */
EAPI void
